<div class="relative flex items-center justify-between group overflow-hidden ">
    ...
    <div class="items-center gap-2 hidden group-hover:flex transition duration-1000 group-hover:mr-4">
        ...
        <a href="{{route('chat.delete', $id)}}" class="border bg-theme-red text-white rounded-full w-7 h-7 flex items-center justify-center hover:scale-110 transition">
